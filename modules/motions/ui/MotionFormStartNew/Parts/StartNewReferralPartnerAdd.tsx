...
import { ContractEvmReferralPartnerAdd } from 'modules/blockChain/contracts'
import { MotionType } from 'modules/motions/types'
import { createMotionFormPart } from './createMotionFormPart'
import { estimateGasFallback } from 'modules/motions/utils/estimateGasFallback'

export const formParts = createMotionFormPart({
  motionType: MotionType.ReferralPartnerAdd,
  ...
  Component: function StartNewMotionMotionFormLego({
    ...
    const existedAddresses = useMemo(() => {
      return (referralPartners.data || []).map(({ address }) => address)
            ...
            rules={{
              ...
              validate: value => {
                ...
                if (existedAddresses.includes(value)) {
                  return 'Referral partner with this address already exists'
                }
                return true
              },
            }}
