...
export const formParts = createMotionFormPart({
  ...
  populateTx: async ({ evmScriptFactory, formData, contract }) => {
    // Check MF0201: Sort the data before sending
                  ...
                  <InputControl
                    ...
                    rules={{
                      ...
                      validate: async value => {
                        ...
                        // Check MF0204: Only valid manager addresses
